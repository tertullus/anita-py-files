...
class TideWidget(QWidget):
    ...
    def inputDict1(self):
        ...
        #dayF = True  # Replace with your actual value for dayfirst
        ...
        data[time_column_name] = pd.to_datetime(data[time_column_name], format=datetime_format, dayfirst=dayF)
    ...
    def howToDialog(self):
        ...
        howTo.setWindowIcon(QIcon(resource_path(r'C:\Users\Olajumoke\Downloads\question.png')))
        closeButton = QPushButton('Close')
        closeButton.clicked.connect(howTo.close)

        how_to_use = open(r'C:\Users\Olajumoke\Pictures\how_to_use.txt', 'r')
